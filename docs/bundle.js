...
*/ var r =
  ...
  function(e, t, n) {
    ...
    var U = /^(.*)[\\\/]/,
      ...
      j = R ? Symbol.for("react.element") : 60103,
        ...
        extractEvents: function(e, t, n, r) {
          ...
          return (
            ...
            (e = kr
              ...
              ? (((t = vr.getPooled(Tr.beforeInput, t, n, r)).data = e), Mt(t))
              : (t = null),
    ...
    var Dr = !1;
    function Ar() {
      Ur && (Ur.detachEvent("onpropertychange", Br), (Rr = Ur = null));
    }
    function Br(e) {
      if ("value" === e.propertyName && Fr(Rr))
        if (((e = Mr(Rr, e, _t(e))), se)) O(e);
        else {
          se = !0;
          try {
            ie(jr, e);
    ...
    function Vr(e, t, n) {
      "focus" === e
        ? (Ar(), (Rr = n), (Ur = t).attachEvent("onpropertychange", Br))
        : "blur" === e && Ar();
    }
    function Wr(e) {
    ...
    function Ql(e) {
      return null === Fl ? ((Fl = [e]), (Ll = Tl(Ol, ql))) : Fl.push(e), Rl;
    }
    function Kl() {
      if (null !== Ll) {
        var e = Ll;
    ...
    function ql() {
      if (!Dl && null !== Fl) {
        ...
        try {
          ...
          throw (null !== Fl && (Fl = Fl.slice(e + 1)), Tl(Ol, Kl), t);
        } finally {
          Dl = !1;
        }
      }
    ...
    function Fi(e) {
      if (e !== Oi) return !1;
      if (!Ii) return ji(e), (Ii = !0), !1;
      var t = e.type;
      if (
        5 !== e.tag ||
        ("head" !== t && "body" !== t && !Zn(t, e.memoizedProps))
      )
        for (t = zi; t; ) Mi(e, t), (t = nr(t.nextSibling));
      if ((ji(e), 13 === e.tag)) {
    ...
    function ro(e, t, n) {
      var r = t.pendingProps,
        l = r.revealOrder,
        a = r.tail;
      if ((Bi(e, t, r.children, n), 0 != (2 & (r = Wa.current))))
      ...
      if ((sl(Wa, r), 0 == (2 & t.mode))) t.memoizedState = null;
      else
        switch (l) {
          case "forwards":
    ...
    function tu(e, t) {
      ...
      return (
        null !== l && (Oo === l && (du(t), 4 === Mo && Du(l, Io)), Au(l, t)), l
      );
    }
    function nu(e) {
    ...
    function lu(e, t) {
      ...
      if (0 !== n) {
        ...
        if ((ku(), (e === Oo && n === Io) || uu(e, n), null !== zo)) {
          var r = No;
          No |= 16;
          for (var l = su(); ; )
            try {
          ...
          if ((na(), (No = r), (_o.current = l), 1 === Mo))
            throw ((t = Uo), uu(e, n), Du(e, n), ru(e), t);
          if (null === zo)
            switch (
    ...
    function au(e) {
      ...
      if (((t = 0 !== t ? t : 1073741823), e.finishedExpirationTime === t))
        ...
        if ((ku(), (e === Oo && t === Io) || uu(e, t), null !== zo)) {
          var n = No;
          No |= 16;
          for (var r = su(); ; )
            try {
          ...
          if ((na(), (No = n), (_o.current = r), 1 === Mo))
            throw ((n = Uo), uu(e, t), Du(e, t), ru(e), n);
    ...
    function yu(e) {
      ...
      do {
        ...
        if (((e = zo.return), 0 == (2048 & zo.effectTag))) {
          e: {
            ...
            switch (t.tag) {
              ...
              case 11:
                break;
              case 13:
                if ((cl(Wa), (a = t.memoizedState), 0 != (64 & t.effectTag))) {
                  t.expirationTime = r;
                  break e;
                }
                (a = null !== a),
                  ...
                  a &&
                    ...
                    0 != (1 & Wa.current)
                      ? 0 === Mo && (Mo = 3)
                      : ((0 !== Mo && 3 !== Mo) || (Mo = 4),
                        0 !== Lo && null !== Oo && (Du(Oo, Io), Au(Oo, Lo)))),
                  (a || o) && (t.effectTag |= 4);
                break;
              case 7:
              case 8:
              ...
              case 17:
                ...
                break;
              case 19:
                if ((cl(Wa), null === (a = t.memoizedState))) break;
                if (
                      ...
                      if (null !== (s = $a(n))) {
                        for (
                          ...
                          (n = a),
                            ...
                            (o = o.sibling);
                        sl(Wa, (1 & Wa.current) | 2), (t = t.child);
                        break e;
                      }
                      n = n.sibling;
                    }
          ...
          if (((a = zo), 1 === Io || 1 !== a.childExpirationTime)) {
    ...
    function bu(e, t) {
      ...
      if (
        ...
        (Gn = { focusedElem: o, selectionRange: u }), (Tn = !1), (Bo = l);
        do {
          try {
            wu();
          } catch (e) {
    ...
    function Su(e, t, n) {
      ...
      null !== r && r.delete(t),
        Oo === e && Io === n
          ? 4 === Mo || (3 === Mo && 1073741823 === Ro && Bl() - Ao < 500)
            ? uu(e, Io)
            : (Do = !0)
          : Lu(e, n) &&
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 4:
          return (
            Da(t, t.stateNode.containerInfo),
            (r = t.pendingProps),
            null === e ? (t.child = Ia(t, null, r, n)) : Bi(e, t, r, n),
            t.child
          );
        case 11:
          return (
      ...
      (t.unstable_scheduleCallback = function(e, n, i) {
        ...
        return (
          ...
          u > o
            ? ((e.sortIndex = u),
              S(O, e),
              null === C(N) && e === C(O) && (j ? a() : (j = !0), l(L, u - o)))
            : ((e.sortIndex = i), S(N, e), R || U || ((R = !0), r(D))),
          e
        );
      }),
  ...
  function(e, t, n) {
    (e.exports = n(1)(!1)).push([
      e.i,
      ".button,.social a{transform-origin:center;transition-duration:100ms}.social{display:flex;margin-top:1.5rem}.social li{height:2rem;margin-right:0.5rem;text-align:center;width:2rem}.social a{align-items:center;display:flex;font-size:1.5rem;height:2rem;justify-content:center;opacity:0.5;transition-property:opacity, transform;width:2rem;will-change:opacity, transform}.social a:hover{opacity:1;transform:scale(1.25)}.social a:active{opacity:1;transform:scale(1.1)}\n",
      ""
    ]);
  },
  function(e, t) {
  ...
  function(e, t, n) {
    (e.exports = n(1)(!1)).push([
      e.i,
      ".picture{padding-top:100%;position:relative;width:100%}.picture-shadow{border-radius:500px;background-image:radial-gradient(#000 0%, rgba(0,0,0,0) 70%);position:absolute;top:10%}.picture-image{border-radius:500px;position:absolute}\n",
      ""
    ]);
  },
  function(e, t, n) {
  ...
  function(e, t, n) {
    (e.exports = n(1)(!1)).push([
      e.i,
      'html{color:#fff;font-family:"Quicksand", sans-serif;font-size:16px;line-height:1.5;min-height:100vh;min-width:300px;overflow-x:hidden;text-shadow:0 3px 5px rgba(0,0,0,0.1)}a{color:white;cursor:pointer;text-decoration:none}.wallpaper,.picture-shadow,.picture-image{display:block;height:100%;left:0;top:0;width:100%}.job,.button{font-family:"Montserrat", "Quicksand", sans-serif;letter-spacing:0.3em;text-transform:uppercase}.wallpaper{background-image:url("images/green-hills.jpg");background-position:center;background-size:cover;opacity:1;position:fixed}.content{display:flex;position:relative;min-height:100vh}.side{max-height:20rem;max-width:20rem}.about{max-width:26rem}.name{font-size:2.25rem;line-height:1.125;margin-bottom:0.5rem}.job{color:#ffe479;font-size:0.75rem}.hr{background-color:#ff470f;border:none;content:"";height:1px;margin-bottom:1.5rem;margin-top:1.5rem;transform-origin:center left;width:4rem}.description{font-size:1.5rem}.contact{display:inline-block;margin-top:1.5rem;vertical-align:top}.button{background-color:#fff;border-radius:500px;box-shadow:0 1rem 2rem rgba(0,0,0,0.2);color:grey;display:inline-block;font-size:0.9rem;line-height:1;padding:1.25em 2em;text-shadow:none;transition-property:box-shadow, transform;user-select:none;vertical-align:top;white-space:nowrap;will-change:box-shadow, transform}.button:hover{box-shadow:0 1.5rem 3rem rgba(0,0,0,0.2);transform:scale(1.02) translateY(-4px)}.button:active{box-shadow:0 0.5rem 1rem rgba(0,0,0,0.3);transform:scale(0.98) translateY(-2px)}@media screen and (max-width: 799px){.content{flex-direction:column;justify-content:center;align-items:center;padding:5rem 3rem}.side{margin-bottom:3rem;width:100%}}@media screen and (min-width: 800px){.content{align-items:center;justify-content:space-around;justify-content:space-evenly;padding:4rem}.side{flex-grow:0;flex-shrink:0;height:20rem;margin-left:4rem;order:2;width:20rem}.about{flex-grow:1;flex-shrink:1}}\n',
      ""
    ]);
  },
  function(e, t, n) {
  ...
  function(e, t, n) {
    (e.exports = n(1)(!1)).push([
      e.i,
      "@keyframes bounceIn{from{opacity:0;transform:scale(0.5)}to{opacity:1;transform:scale(1)}}@keyframes fillUp{from{transform:scaleX(0)}to{transform:scaleX(1)}}@keyframes picImage{from{opacity:0;transform:scale(1.2) translateY(-1rem)}to{opacity:1;transform:scale(1) translateY(0)}}@keyframes picShadow{from{opacity:0;transform:scale(1.2) translateY(4rem)}to{opacity:1;transform:scale(1.1) translateY(0)}}@keyframes slideDown{from{opacity:0;transform:translateY(-1rem)}to{opacity:1;transform:translateY(0)}}@keyframes slideUp{from{opacity:0;transform:translateY(1rem)}to{opacity:1;transform:translateY(0)}}@keyframes zoomOut{from{opacity:0;transform:scale(1.05)}to{opacity:0.9;transform:scale(1)}}.wallpaper,.picture-shadow,.picture-image,.name,.job,.hr,.description,.contact,.social li{animation-duration:1s;animation-timing-function:cubic-bezier(0, 0.5, 0, 1);animation-fill-mode:both}.wallpaper{animation-timing-function:ease-out}.picture-shadow,.picture-image{animation-duration:750ms;animation-timing-function:cubic-bezier(0, 0.5, 0.25, 1.25)}.wallpaper,.picture-shadow,.picture-image{opacity:0}.wallpaper{animation-name:zoomOut}.picture.is-loaded .picture-shadow{animation-name:picShadow}.picture.is-loaded .picture-image{animation-name:picImage}.name{animation-name:slideDown}.job{animation-name:slideUp}.hr{animation-name:fillUp}.description{animation-name:slideUp}.contact{animation-name:bounceIn}.social li{animation-duration:500ms;animation-name:slideUp;animation-timing-function:cubic-bezier(0.5, 0, 0.5, 1.5)}.name{animation-delay:100ms}.job{animation-delay:200ms}.hr{animation-delay:300ms}.description{animation-delay:400ms}.picture-image{animation-delay:500ms}.picture-shadow{animation-delay:500ms}.contact{animation-delay:600ms}.social li:nth-child(1){animation-delay:800ms}.social li:nth-child(2){animation-delay:900ms}.social li:nth-child(3){animation-delay:1s}.social li:nth-child(4){animation-delay:1.1s}.wallpaper.is-loaded{animation-delay:1s}\n",
      ""
    ]);
  },
  function(e, t, n) {
  ...
  function(e, t) {
    function n(e, t) {
      var n,
        ...
        l = t ? document.getElementById(t) : r;
      if (
        (n = r.dataset.image
          ? r.dataset.image
          : void 0 === r.currentSrc
    ...
    document.addEventListener("DOMContentLoaded", function() {
      n("wallpaper"), n("pictureImage", "picture");
    });
  },
  function(e, t, n) {
    "use strict";
              ...
              return l.a.createElement(
                ...
                l.a.createElement(
                  ...
                  l.a.createElement(
                    "a",
                    { href: "https://github.com/Subtora" },
                    l.a.createElement("i", { className: "fab fa-linkedin" })
                  )
                )
              );
            }
    ...
    var w = (function(e) {
      function t() {
        return h(this, t), v(this, g(t).apply(this, arguments));
      }
      var n, r, a;
      return (
        (function(e, t) {
        ...
        (r = [
          {
            ...
            value: function() {
              return l.a.createElement(
                ...
                l.a.createElement("div", { className: "picture-shadow" }),
    ...
    var _ = (function(e) {
      function t() {
        return E(this, t), T(this, S(t).apply(this, arguments));
      }
      var n, r, a;
      return (
        (function(e, t) {
              ...
              return l.a.createElement(
                ...
                l.a.createElement(
                  ...
                  l.a.createElement(
                    ...
                    l.a.createElement("hr", { className: "hr" }),
                    l.a.createElement(
                      "div",
                      { className: "description" },
                      l.a.createElement("p", null, "just another description")
                    ),
                    l.a.createElement(
                      "div",
                      { className: "contact" },
    ...
    i.a.render(l.a.createElement(_, null), document.getElementById("root"));
  }
]);
